...
export default class CWEEnum extends React.Component {
    ...
    renderCWERows = (props) => {
        ...
        return (
            <ListItem button style={style} key={index} onClick={(event) => this.handleSelectCWERow(event, index)}>
    ...
    render() {
        ...
        return <div>
            CWEEnum
            <FixedSizeList height={400} width={300} itemSize={46} itemCount={this.state.cweList.length}>
                {this.renderCWERows}
            </FixedSizeList>
